        ...
        ->actions([
            ...
            Action::make('customButton')
                ...
                if ($telegram && $imageUrl) {
                    ...
                    $caption .= "\n{$record->translateAttribute('description')}\n";
                    $caption .= "\nPrice: {$price?->price->formatted()}";

                    $response = Http::post("https://api.telegram.org/bot{$telegram->bot_token}/sendPhoto", [
                        'chat_id' => '@' . ltrim($telegram->channel_username, '@'),
                        'photo'   => $imageUrl,
                        'caption' => $caption,
                    ...
                    Log::warning('Missing Telegram config or product image.');
                }
})
            ...
            Tables\Actions\BulkActionGroup::make([
                Tables\Actions\DeleteBulkAction::make(),
                  BulkAction::make('bulkExport')
                    ...
                    // $records is a collection of selected Product models
                    ...
                    foreach ($records as $record) {
                       ...
                       if ($telegram && $imageUrl) {
                            $caption = "Product: {$record->translateAttribute('name')}\n";
                            $caption .= "Description: {$variant->description}\n";
                            $caption .= "Price: {$price?->price->formatted()}";
                    ...
                    Log::info('Exporting products completed.');
                    }),
            ]),
        ])
