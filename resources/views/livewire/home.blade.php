<div>
    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-12 sm:px-6 lg:px-8">
        ...
        @if ($this->allCollections && $this->allCollections->count())
            <section class="space-y-12">
                <h2 class="text-3xl font-bold">All Collections</h2>
                ...
                @foreach ($this->allCollections as $collection)
                    <div>
                        ...
                        <div class="grid grid-cols-2 mt-6 lg:grid-cols-4 gap-x-4 gap-y-8">
